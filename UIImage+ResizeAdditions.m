...
/// around the edges of the thumbnail. (Adding a transparent border of at least one pixel in
/// size has the side-effect of antialiasing the edges of the image when rotating it using
/// Core Animation.)
